...
function CreatePlaylistModal({
  ...
  const closeModal = () => {
    setIsVisible(false); // Desativar a visibilidade do modal antes de sair da tela
    setTimeout(() => setShowModal(false), 300); // Definir um atraso para fechar o modal após a animação
  };
  ...
  return (
    <div>
      ...
      >
        <div className="bg-black p-4 rounded-lg space-y-4 border-2 border-darkGreen w-full max-w-96">
